#!/usr/bin/env python3
"""
Object-file disassembly + normalization, vendored unchanged from
decomp-permuter (MIT): https://github.com/simonlindholm/decomp-permuter
(src/objdump.py). Supports scorer.py.
"""
