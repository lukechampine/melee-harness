...
class Permuter:
    ...
    def __init__(
        ...
        *,
        ...
        self.permute_fn_names = permute_fn_names
        ...
        # Display-only objdiff percentage tracking. Seeded from the wrapper's
        # --baseline-percent (if given) and updated on each heuristic best
        # improvement; the live counter in main.py renders it.
        self.baseline_percent: Optional[float] = None
        self.best_percent: Optional[float] = None
    ...
    def _create_and_score_base(self) -> Tuple[int, str, str]:
        ...
        base_cand = Candidate.from_source(
            ...
            rng_seed=0,
            permute_fn_names=self.permute_fn_names,
        )
